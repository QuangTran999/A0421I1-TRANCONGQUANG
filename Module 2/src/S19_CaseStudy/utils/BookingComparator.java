...
public class BookingComparator implements Comparator<Booking> {
    ...
    public int compare(Booking o1, Booking o2) {
        ...
        LocalDate startDate1 = LocalDate.parse(o1.getStartTime(), formatter);
        LocalDate startDate2 = LocalDate.parse(o2.getStartTime(), formatter);
