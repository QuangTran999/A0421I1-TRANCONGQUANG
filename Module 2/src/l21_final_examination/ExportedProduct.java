...
public class ExportedProduct extends l21_final_examination.Product {
    ...
    public ExportedProduct(int id, String codeProduct, String nameProduct, Double price, int quantity,
                           String producer, double exportPrice, String importProductCountry) {
