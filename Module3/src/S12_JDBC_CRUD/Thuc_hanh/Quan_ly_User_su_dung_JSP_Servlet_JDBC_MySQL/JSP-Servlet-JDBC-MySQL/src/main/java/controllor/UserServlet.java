...
public class UserServlet extends HttpServlet {
    ...
    private void showSortUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setAttribute("listUser", this.userDAO.sortUser());
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("user/list.jsp");
        requestDispatcher.forward(request, response);
    }

    private void showFindUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void findUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("listUser", this.userDAO.findUser(country));
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("user/find.jsp");
        requestDispatcher.forward(request, response);
